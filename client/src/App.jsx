...
import RagIndexingDashboard from './pages/RagIndexingDashboard';
...
export default function App() {
  return (
    <Routes>
      ...
      <Route element={<Protected roles={['student', 'faculty', 'admin']}><AppShell /></Protected>}>
        <Route path="/notifications" element={<Notifications />} />
      </Route>

      <Route element={<Protected roles={['student', 'faculty']}><AppShell /></Protected>}>
      ...
      <Route element={<Protected roles={['faculty']}><AppShell /></Protected>}>
        ...
        <Route path="/faculty/rag" element={<RagIndexingDashboard />} />
